...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
            ...
            mApiClient = new GoogleApiClient.Builder(getContext())
                    ...
                    .addConnectionCallbacks(new GoogleApiClient.ConnectionCallbacks() {
                        ...
                        public void onConnected(@Nullable Bundle bundle) {
                            sendWeatherMessageToWatchFace(weatherId, high,
                                    low);
                        }
    ...
    private void sendWeatherMessageToWatchFace(int iconResourceId, double high, double low){

        final String message = String.valueOf(iconResourceId) + ":" + Utility.formatTemperature(getContext(), high) + ":" + Utility.formatTemperature(getContext(), low);
